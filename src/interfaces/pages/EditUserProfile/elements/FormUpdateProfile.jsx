...
const FormUpdateProfile = () => {
  ...
  return (
    <ContainerForm>
      <Form className="editForm" onSubmit={(e) => handleUpdateProfile(e,userProfile)}>
        ...
        <InputField
          ...
          name="displayName"
          required
          onChange={(e) => handleChangeUpdateProfile(e, userProfile, setUserProfile)}
        />
        ...
        />
        <ButtonUpdate />
        <ToastContainer position="top-center" hideProgressBar={false} theme="colored"/>
      </Form>
    </ContainerForm>
  );
};
